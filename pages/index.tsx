...
const IndexPage = () => (
  <Layout title="Perfectum AI - AI powered learning management system- coming soon">
    <img
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        ...
        <p className="text-xl lg:text-2xl tracking-wide mx-10 lg:max-w-xl lg:mx-auto">
          We`re building a awesome learning platform. Check back for an update
          soon. Stay in touch!
        </p>
      </div>
